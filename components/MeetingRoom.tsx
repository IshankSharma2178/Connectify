  ...
  return (
    <section className='relative h-screen w-full overflow-hidden pt-4 text-white'>
      <div className='relative flex size-full items-center justify-center'>
        ...
        <div className={cn('h-[calc(10vh-86px)] hidden ml-2',{'show-block':showParticipants})}>
      ...
      <div className='fixed bottom-0 flex w-full items-center justify-center gap-5'>
        ...
        <DropdownMenu>
          <div className='flex items-center'>
            <DropdownMenuTrigger className='cursor-pointer rounded-2xl bg-[#19232d] px-4 p-2 hover:bg-[#4c535b]'>
        ...
        <button onClick={()=>setShowParticipants((prev)=>!prev)}>
          <div className='cursor-pointer rounded-2xl bg-[#19232d] px-4 p-2 hover:bg-[#4c535b]'>
